...
function f1(){
   ...
   if (input == 4) {document.querySelector(".out-1").innerHTML = "true" ;
} 
...
function f2(){
   if (a21 > a22) {document.querySelector(".out-2").innerHTML = a21}
   else {document.querySelector(".out-2").innerHTML = a22}
}
...
function f3(){
   ...
   (a > b) ? document.querySelector(".out-3").innerHTML = a 
...
function f4(){
   let a = parseFloat(document.querySelector(".i-4").value) ;
   (( 2023 - a) >= 18) ? document.querySelector(".out-4").innerHTML = "1" 
...
function f5(){
   let as = document.querySelector(".i-5").value ;
   if ( as < 0) {document.querySelector(".out-5").innerHTML = "m"} 
   else if (as == 0) {document.querySelector(".out-5").innerHTML = "0"} 
   else if (as > 0) {document.querySelector(".out-5").innerHTML = "1"} 
}
...
function f6(){
   ...
   if ( a6 % 2 == 0 ) {document.querySelector(".out-6").innerHTML = "парне"}
   else {document.querySelector(".out-6").innerHTML = "непарне"}
}
...
function f7(){
   let a7 = parseFloat(document.querySelector(".i-71").value) ;
   let b7 = parseFloat(document.querySelector(".i-72").value) ;
   document.querySelector(".out-7").innerHTML = a7 ** b7 ;
}
...
function f8(){
   let a8 = document.querySelector(".s-8").value ;
   switch (a8) {
...
function f9(){
   ...
   if (a9 >= 1 && a9 <=32) {document.querySelector(".out-9").innerHTML = "1"}
   else if (a9 >= 33 && a9 <=43) {document.querySelector(".out-9").innerHTML = "2"}
   else if (a9 >= 34 && a9 <=64) {document.querySelector(".out-9").innerHTML = "3"}
...
// тобто все що з інп стрінг бо то баче як контент?
...
function f14(){
   let a14 = parseFloat(document.querySelector(".i-141").value) ;
   let a24 = parseFloat(document.querySelector(".i-142").value) ;
   let a34 = document.querySelector(".s-143").value ;
   if (a34 == "/") {
      document.querySelector('.out-14').innerHTML = a14 / a24 ;
  } else if (a34 == "+") {
      document.querySelector('.out-14').innerHTML = a14 + a24 ;
  } else if (a34 == "-") {
      document.querySelector('.out-14').innerHTML = a14 - a24 ;
...
function f15(){
   let s = document.querySelector(".s-151").value ;
   ...
   } else if (s3 == "&&") {document.querySelector(".out-15").innerHTML = "0" ;
   } else if (s3 == "||" && s == "0" && s2 == "0") {
      document.querySelector(".out-15").innerHTML = "0" ;
   } else if ( s3 == "||") {document.querySelector(".out-15").innerHTML = "1"} ;
