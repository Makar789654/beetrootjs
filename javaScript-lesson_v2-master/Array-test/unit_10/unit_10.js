...
// let ar3 =  // переменную обьявляем здесь!!!!
    let ar3 = ["apple", "orange", "banan", "cocos", 16654]
    function f3() {
...
// let ar6 =
    let ar6 = ["roman ", " cancer", " 28", " 06" ]
function f6() {
    document.querySelector("div.out-6").innerHTML = ar6
}
...
let ar8 = ["", null, "", "3.14", "17" , "" , "5"];

function f8() {
    document.querySelector(".out-8").innerHTML = ar8.length
}
...
function f10() {
    document.querySelector(".out-10").innerHTML = ar9[1] + ar9[ar9.length - 1];
}
...
function f14() {
    ar14.reverse()
    document.querySelector(".out-14").innerHTML = ar14
}
...
function f15() {
    ar151 = ar15.filter(function(number){return number > 0})
        document.querySelector(".out-15").innerHTML = ar151
    }
