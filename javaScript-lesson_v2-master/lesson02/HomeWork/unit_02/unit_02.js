...
function t12() {
    let fName = document.querySelector('.i-12-1').value; 
    let sName = document.querySelector('.i-12-2').value;
    document.querySelector(".out-12").textContent = "Hello " + fName + " " + sName ;
}
...
function t13() {
    let fNumber = document.querySelector('.i-13-1').value; 
    let sNumber = document.querySelector('.i-13-2').value;
    fNumber = Number(fNumber) ;
    sNumber = Number(sNumber) ;
    document.querySelector(".out-13").textContent = fNumber + sNumber ;
}
...
function t15() {
    let mBtn = document.querySelector(".i-15") ;
    mBtn.style.border ="4px solid red";
}
...
function t16() {
    let fNumber = document.querySelector('.i-16-1').value; 
    let sNumber = document.querySelector('.i-16-2').value;
    document.querySelector(".out-16").textContent = fNumber + sNumber ;
}
...
function t19() {
    let fNumber = document.querySelector('.i-19-1').value; 
    let sNumber = document.querySelector('.i-19-2').value;
    fNumber = Number(fNumber) ;
    sNumber = Number(sNumber) ;
    document.querySelector(".out-19").textContent = fNumber + sNumber ;
}
