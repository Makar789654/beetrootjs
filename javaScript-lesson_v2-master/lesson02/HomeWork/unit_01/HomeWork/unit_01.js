...
let z1 = 6;
let z2 = 3;
let z3 = document.querySelector("div.out-14").innerHTML = z1 * z2 ;

// Task 15.
// Создайте две переменных y1 = 6, y2 = 3. В div.out-15 выведите результат него деления y1 на y2.
let y1 = 6 ;
let y2 = 3 ;
let y3 = document.querySelector("div.out-15").innerHTML = y1 / y2 ;
...
let out18 = document.querySelector(".out-18").innerHTML = 5 ;
console.log(out18);
